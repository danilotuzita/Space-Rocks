...
setup_button_ext(0, 0, 0, 0, main_hud.icons_sprite, HUD_ICON_CONTINUE, true, 120, 30, 1, 0, pause_menu_scr_continue, main_hud.hud_acc_color, true, pause_menu_btn_custom_draw, "CONTINUE");
setup_button_ext(1, 0, 0, 0, main_hud.icons_sprite,     HUD_ICON_QUIT, true, 120, 30, 1, 0,     pause_menu_scr_quit, main_hud.hud_acc_color, true, pause_menu_btn_custom_draw, "QUIT.MISSION");
