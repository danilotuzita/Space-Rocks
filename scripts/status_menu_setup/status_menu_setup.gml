...
setup_button_ext(1, 0, -100, 115, spr_status_menu_buttons_block, 1, false, 64, 64, 2, 0, status_menu_scr_equip, main_hud.hud_acc_color, true, status_menu_btn1_custom_draw, -2); // ???
