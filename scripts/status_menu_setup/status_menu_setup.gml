...
setup_button_ext(-1, 0, 0, 0, global.player.sprite_index, 0, true, 32, 32, 5, 90, do_nothing, main_hud.hud_color, false, status_menu_btn1_custom_draw, 0);

setup_button_ext(0, 0,   70, -50, spr_test, 0, true, 64, 64, 2, 0, status_menu_cancel, main_hud.hud_acc_color, true, status_menu_btn1_custom_draw, -1);
setup_button_ext(1, 0, -100,  90, spr_test, 1, true, 64, 64, 2, 0, status_menu_cancel, main_hud.hud_acc_color, true, status_menu_btn1_custom_draw, -1);
